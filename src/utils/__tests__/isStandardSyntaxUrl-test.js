...
test("isStandardSyntaxUrl", t => {
  ...
  t.notOk(isStandardSyntaxUrl("$sass-variable + test"), "sass variable and concatenation")
  t.notOk(isStandardSyntaxUrl("test + $sass-variable + test"), "sass variable and concatenation")
